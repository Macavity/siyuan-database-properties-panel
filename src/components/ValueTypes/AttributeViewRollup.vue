...
<template>
  ...
  <template v-else-if="value.type === 'url'">
    <a v-if="value.url.content" class="fn__a" :href="value.url.content" target="_blank">{{ value.url.content }}</a>
  </template>
  <template v-else-if="value.type === 'phone'">
    <a v-if="value.phone.content" class="fn__a" :href="`tel:${value.phone.content}`" target="_blank">{{ value.phone.content }}</a>
  </template>
  <template v-else-if="value.type === 'email'">
    <a v-if="value.email.content" class="fn__a" :href="`mailto:${value.email.content}`" target="_blank">{{ value.email.content }}</a>
  </template>
</template>
